...
public class UserController {
    ...
    public ResponseEntity<ApiResponse> getAllUsers(
        ...
        return ResponseEntity.ok(new ApiResponse("getting users ", userDtos));
    }
    ...
    public ResponseEntity<ApiResponse> createUser(@RequestBody AddingUserRequest addRequest) {
        ...
        return ResponseEntity.ok(new ApiResponse("creating user ", userDto));
    }
    ...
    public ResponseEntity<ApiResponse> UpdateUser(@RequestBody UpdatingUserRequest updateRequest) {
        ...
        return ResponseEntity.ok(new ApiResponse("updating user ", userDto));
    }

    @DeleteMapping
    public ResponseEntity<ApiResponse> deleteUser(@RequestParam Integer id) {
        userService.deleteUser(id);
        return ResponseEntity.ok(new ApiResponse("deleting user ", id));
    }
