...
VALUES ('Scholastic', '557 Broadway, New York, NY', 'contact@scholastic.com'),
       ('Penguin Books', '123 Penguin Ave, London', 'info@penguin.com'),
       ('HarperCollins', '195 Broadway, New York, NY', 'support@harpercollins.com');

-- Insert Authors
INSERT INTO authors (name, nationality, bio)
VALUES ('J.K. Rowling', 'British', 'Author of the Harry Potter series'),
...
VALUES (4, 1), -- Fantasy under Fiction
       (3, 1), -- Sci-Fi under Fiction
       (9, 1), -- Dystopian under Fiction
       (8, 1);
-- Classic under Fiction

-- Insert Books (10 books with different categories and publishers)
INSERT INTO books (title, isbn, year, quantity, edition, language, summary, publisher_id)
VALUES ('Harry Potter and the Philosopher''s Stone', '978-0747532743', 1997, 5, '1st', 'EN',
        'The boy who lived starts his journey', 1),
...
VALUES (1, 1), -- J.K. Rowling -> Harry Potter
...
VALUES (1, 4), -- Harry Potter -> Fantasy
       (2, 9), -- 1984 -> Dystopian
...
-- Insert Members
INSERT INTO members (full_name, email, max_borrow_limit)
VALUES ('John Smith', 'john.smith@email.com', 5),
...
VALUES (1, 1, 1, 'libadmin', '2023-10-01', 'libadmin', '2023-10-01', '2023-10-15', '2023-10-15', null),
